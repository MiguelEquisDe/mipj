            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <li class="list-group-item">{{ $co->apellido }}</li>
                        <li class="list-group-item">{{ $co->titulo }}</li>
                        <li class="list-group-item">{{ $co->cursoasociado }}</li>
                        {{-- <li class="list-group-item">{{ $co->description }}</li> --}}
                        <br>
                        <center>
                            <a href="/docentes/{{ $co->id }}" class="btn btn-dark">Yamete!!!</a>
                        </center>
                    </div>
                </div>
            </div>
